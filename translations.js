const I18N = {
    ...
    translations: {
        en: {
            ...
            mlk_day: "MLK Day (Holiday Schedule)",
            presidents_day: "Presidents' Day (Holiday Schedule)",
            memorial_day: "Memorial Day (Holiday Schedule)",
            juneteenth: "Juneteenth (Holiday Schedule)",
            independence: "Independence Day (Holiday Schedule)",
            labor_day: "Labor Day (Holiday Schedule)",
            columbus_day: "Columbus Day (Holiday Schedule)",
            veterans: "Veterans Day (Potential Holiday Schedule)",
            thanksgiving: "Thanksgiving (Holiday Schedule)",
            ...
            schedule_data: "Schedule data: Static GTFS snapshot (real-time delays not included)",
        ...
        es: {
            ...
            mlk_day: "Día de MLK (Horario Festivo)",
            presidents_day: "Día de los Presidentes (Horario Festivo)",
            memorial_day: "Día de los Caídos (Horario Festivo)",
            juneteenth: "Juneteenth (Horario Festivo)",
            independence: "Día de la Independencia (Horario Festivo)",
            labor_day: "Día del Trabajo (Horario Festivo)",
            columbus_day: "Día de Colón (Horario Festivo)",
            veterans: "Día de los Veteranos (Posible Horario Festivo)",
            thanksgiving: "Día de Acción de Gracias (Horario Festivo)",
            ...
            schedule_data: "Datos de horarios: Instantánea estática de GTFS (no incluye retrasos en tiempo real)",
        ...
        zh: {
            ...
            new_years: "元旦（节假日时刻表）",
            mlk_day: "马丁·路德·金纪念日（节假日时刻表）",
            presidents_day: "总统日（节假日时刻表）",
            memorial_day: "阵亡将士纪念日（节假日时刻表）",
            juneteenth: "六月节（节假日时刻表）",
            independence: "独立日（节假日时刻表）",
            labor_day: "劳动节（节假日时刻表）",
            columbus_day: "哥伦布日（节假日时刻表）",
            veterans: "退伍军人日（可能的节假日时刻表）",
            thanksgiving: "感恩节（节假日时刻表）",
            ...
            contact: "联系",
            world_history: "世界历史",
            schedule_data: "时刻表数据：GTFS 静态快照（不包含实时延误）",
        ...
        ru: {
            ...
            mlk_day: "День Мартина Лютера Кинга (праздничное расписание)",
            presidents_day: "День президентов (праздничное расписание)",
            memorial_day: "День памяти (праздничное расписание)",
            juneteenth: "Джинайтен (праздничное расписание)",
            independence: "День независимости (праздничное расписание)",
            labor_day: "День труда (праздничное расписание)",
            columbus_day: "День Колумба (праздничное расписание)",
            veterans: "День ветеранов (возможно праздничное расписание)",
            thanksgiving: "День благодарения (праздничное расписание)",
            ...
            terms: "Условия",
            contact: "Контакты",
            world_history: "Мировая история",
            schedule_data: "Данные расписания: статический снимок GTFS (задержки в реальном времени не включены)",
        ...
        bn: {
            ...
            mlk_day: "এমএলকে দিবস (ছুটির সময়সূচী)",
            presidents_day: "রাষ্ট্রপতি দিবস (ছুটির সময়সূচী)",
            memorial_day: "স্মৃতি দিবস (ছুটির সময়সূচী)",
            juneteenth: "জুনটিনথ (ছুটির সময়সূচী)",
            independence: "স্বাধীনতা দিবস (ছুটির সময়সূচী)",
            labor_day: "শ্রমিক দিবস (ছুটির সময়সূচী)",
            columbus_day: "কলম্বাস দিবস (ছুটির সময়সূচী)",
            veterans: "সেনানী দিবস (সম্ভাব্য ছুটির সময়সূচী)",
            thanksgiving: "থ্যাংকসগিভিং (ছুটির সময়সূচী)",
            ...
            terms: "শর্তাবলী",
            contact: "যোগাযোগ",
            world_history: "বিশ্ব ইতিহাস",
            schedule_data: "সময়সূচীর ডেটা: GTFS স্ট্যাটিক স্ন্যাপশট (রিয়েল-টাইম বিলম্ব অন্তর্ভুক্ত নয়)",
